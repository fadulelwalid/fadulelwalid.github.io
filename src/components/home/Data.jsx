...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Fadul Elwalid Fadul
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">
                I'm a recent Master of Science in Computer Science graduate, based in Norway, eager to apply my skills and grow as a developer.  
            </p>
